...
export const metadata: Metadata = {
  title: "Local SEO Blog | Google Business Profile Tips for WA Businesses",
  description:
    "Practical local SEO and Google Business Profile advice for businesses in Mandurah, Rockingham, and Perth. Guides, tips, and how-tos to help you rank in the Google Map Pack.",
  alternates: {
    canonical: "https://csdigitalmarketing.au/blog",
  },
};
      ...
      <section className="relative text-white py-20 md:py-28 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 text-center relative z-10">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-5 tracking-tight animate-fade-up-delay-1">
            Local SEO &amp; <span className="gold-gradient-text">GBP Tips</span>
          </h1>
          <p className="text-lg text-white/60 max-w-2xl mx-auto leading-relaxed animate-fade-up-delay-2">
            Practical advice on getting your local business found on Google.
            No jargon, no fluff.
          </p>
        </div>
      </section>
      ...
      <section className="hero-gradient py-20 md:py-24 relative">
        <div className="max-w-3xl mx-auto px-6 text-center relative z-10">
          ...
          <p className="text-white/50 mb-10 text-lg max-w-lg mx-auto">
            Reading is one thing. We will audit your Google Business Profile
