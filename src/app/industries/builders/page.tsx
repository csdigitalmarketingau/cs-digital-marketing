...
export default function BuildersPage() {
  return (
    <>
      ...
      <ServiceJsonLd
        name="GBP Optimisation for Builders"
        description="Google Business Profile optimisation for builders and construction businesses in Mandurah, Rockingham, and Perth."
        url="https://csdigitalmarketing.au/industries/builders"
      />
      {/* Hero */}
