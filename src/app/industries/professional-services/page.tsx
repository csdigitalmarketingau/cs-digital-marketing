...
export default function ProfessionalServicesPage() {
  return (
    <>
      ...
      <ServiceJsonLd
        name="GBP Optimisation for Professional Services"
        description="Google Business Profile optimisation for accountants, lawyers, and financial advisers in Mandurah, Rockingham, and Perth."
        url="https://csdigitalmarketing.au/industries/professional-services"
      />
      {/* Hero */}
      ...
      <section className="hero-gradient py-20 md:py-24 relative">
        <div className="max-w-3xl mx-auto px-6 text-center relative z-10">
          ...
          <Link href="/contact" className="btn-glow inline-flex items-center gap-2 bg-gold hover:bg-gold-light text-navy font-semibold px-8 py-4 rounded-xl text-base transition-colors">
            Get Your Free Professional Services Audit
