...
export default function LocksmithsPage() {
  return (
    <>
      ...
      <ServiceJsonLd
        name="GBP Optimisation for Locksmiths"
        description="Google Business Profile optimisation for locksmiths in Mandurah, Rockingham, and Perth."
        url="https://csdigitalmarketing.au/industries/locksmiths"
      />
      {/* Hero */}
