        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-sm mt-3 leading-relaxed">
              Helping local businesses in Mandurah and surrounding areas get found on Google.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a href="mailto:coen@csdigitalmarketing.au" className="hover:text-gold transition-colors">
                  coen@csdigitalmarketing.au
                </a>
              </li>
              <li>
                <a href="tel:0466498861" className="hover:text-gold transition-colors">
                  0466 498 861
                </a>
              </li>
